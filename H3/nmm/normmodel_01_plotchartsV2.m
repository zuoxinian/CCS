...
set([hXLabel, hYLabel], 'FontName', 'Helvetica', 'FontSize', 20, ...
    'FontWeight', 'bold');
set(gca, ...
        'Box'         , 'on'     , ...
        'TickDir'     , 'out'      , ...
...
print('-dpng','-r300', [fig_dir '/growthcharts_updateV2.png'])
close;
...
%export to PNG
set(gcf, 'PaperPositionMode', 'auto', 'Color', 'white', 'InvertHardCopy','off');
print('-dpng','-r300', [fig_dir '/growthcharts.females_updateV2.png'])
close;
...
%export to PNG
set(gcf, 'PaperPositionMode', 'auto', 'Color', 'white', 'InvertHardCopy','off');
print('-dpng','-r300', [fig_dir '/growthcharts.males_updateV2.png'])
close;
