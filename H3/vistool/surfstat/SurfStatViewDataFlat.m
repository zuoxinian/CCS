function [ a, cb ] = SurfStatViewDataFlat( data, surf, title, background)
...
% title       = any string, data name by dull.
% background  = background colour, any matlab ColorSpec, such as 
%   'white' (dull), 'black'=='k', 'r'==[1 0 0], [1 0.4 0.6] (pink) etc.
...
%
% Created from SurfStatViewData.m by Xi-Nian Zuo in Jan 09, 2015.
...
lighting none; material dull; shading flat;
