function r = ccs_mri_surfrft_jlbr(yfile,glmdir,vwthresh,sgn,subject,hemi)
% r = ccs_mri_surfrft_jlbr(yfile,glmdir,vwthresh,<sgn>,<subject>,<hemi>)
%
...
% $Id: ccs_mri_surfrft_jlbr.m,v 1.25 2012/12/21 4:22 Xi-NIan Exp $
