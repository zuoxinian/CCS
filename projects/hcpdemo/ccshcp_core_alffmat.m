function [ cALFF, cFALFF, Nt] = ccshcp_core_alffmat(tsmat, TR, f_lp, f_hp )
% CCSHCP_CORE_ALFFMAT Compute the amplitude/phase of low-frequency fluctuations
%   (LFFs) by using stationary (classic FFT).
%
