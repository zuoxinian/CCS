function [ R, Reff ] = IPN_doSingleSubject_regionCENT_cameron( infname, maskfname, template, outfprefix, p )
...
id_cer = [9 10 30 36 41 52 152 192 176 162 194 68 130 120 80 103 86 118 126 77 52 190];
id_nocer = setdiff(1:200, id_cer);
id_effROIs = intersect(id_nocer, id_ROIs_buffer(id_ROIs_buffer > 0));
...
save([outfprefix '/ts_cameron.mat'], 'ROI_TS')
save([outfprefix '/rsfc_cameron.mat'], 'R', 'Reff', 'Zf', 'Zs', 'id_effROIs')
save([outfprefix '/cent_cameron.mat'], 'DCb', 'ECb', 'PCb', 'SCb', 'CCb', 'BCb', ...
